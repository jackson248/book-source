...
echo "/pet ${code_pet#&}" >> sharecode.txt
#echo "/jxcfd ${code_jxcfd#&}" >> sharecode.txt
echo "/sgmh ${code_sgmh#&}" >> sharecode.txt
echo "/bean ${code_bean#&}" >> sharecode.txt
#echo "/health ${code_health#&}" >> sharecode.txt
#echo "/city ${code_city#&}" >> sharecode.txt
#while read line
#do
...
#echo "/carnivalcity ${code_carnivalcity#&}" >> sharecode.txt
